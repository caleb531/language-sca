describe "SSP (environment) grammar", ->
  grammar = null
  ...
  it "tokenizes <%= %> tags", ->
    ...
    expect(tokens[2]).toEqual value: 'var', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'storage.type.var.js']
    expect(tokens[7]).toEqual value: 'foo', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'string.quoted.double.js']
  ...
  it "tokenizes <% %> tags with unclosed block", ->
    ...
    expect(tokens[0]).toEqual value: '<%', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'entity.name.tag.sca.ssp']
    expect(tokens[2]).toEqual value: 'if', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'keyword.control.js']
  ...
  it "tokenizes <% %> tags with unclosed block (no space)", ->
    ...
    expect(tokens[0]).toEqual value: '<%', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'entity.name.tag.sca.ssp']
    expect(tokens[2]).toEqual value: 'if', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'keyword.control.js']
    expect(tokens[9]).toEqual value: '%>', scopes: ['source.js.sca.ssp', 'meta.embedded.sca.ssp', 'entity.name.tag.sca.ssp']
